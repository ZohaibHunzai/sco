...
namespace backend\modules\inbox\controllers;

use Yii;
use backend\modules\inbox\models\Thread;
use backend\modules\inbox\models\Message;
use backend\modules\inbox\models\ThreadSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * InboxController implements the CRUD actions for Thread model.
 */
