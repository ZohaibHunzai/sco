...
<div class="product-form">
    ...
    <div class="form-group">
        <?php echo Html::submitButton($model->isNewRecord ? 'Add New Article' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-success btn-flat btn-block' : 'btn btn-primary btn-flat btn-block']) ?>
    </div>
